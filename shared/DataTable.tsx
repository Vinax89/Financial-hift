...
export interface DataTableProps<T = any> {
  ...
  /** Function to render each row (receives item and index) */
  renderRow: (item: T, index: number) => React.ReactNode;
  /** Loading state */
  isLoading?: boolean;
  /** Number of skeleton rows to show when loading */
  loadingRows?: number;
  /** Custom empty state component/element */
  ...
  className?: string;
  /** Optional CSS class for table element */
...
/**
 * Generic data table component with search, pagination, and loading states
 */
