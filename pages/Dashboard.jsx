...
import DataExport from "@/shared/DataExport.jsx";
import { generateFinancialReport } from "@/api/functions";
import { User } from "@/api/entities";
import UpcomingDue from "@/dashboard/UpcomingDue.jsx";
...
const IncomeViabilityCalculator = React.lazy(() => import('@/tools/IncomeViabilityCalculator.jsx'));
const AutomationCenter = React.lazy(() => import('@/dashboard/AutomationCenter.jsx'));
const DataImporter = React.lazy(() => import('@/tools/DataImporter.jsx'));
...
export default function Dashboard() {
    ...
    useIdlePrefetch([
        ...
        () => import("@/tools/IncomeViabilityCalculator.jsx"),
        () => import("@/scanning/ReceiptScanner.jsx"),
        () => import("@/tools/DataImporter.jsx"),
