 ...
 * @description Displays assets, liabilities, and net worth
 */

import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/ui/card';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow, TableFooter } from '@/ui/table';
import type { BalanceSheetData, BalanceSheetItem } from '@/types/financial.types';
 ...
 * @component
 * @param {BalanceSheetProps} props - Component props
 * @returns {JSX.Element | null} Balance sheet display
 */
export default function BalanceSheet({ data, date }: BalanceSheetProps): JSX.Element | null {
    if (!data) return null;
