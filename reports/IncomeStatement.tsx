 ...
 * @description Displays revenue, expenses, and net income breakdown
 */

import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/ui/card';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow, TableFooter } from '@/ui/table';
import type { IncomeStatementData, CategoryItem } from '@/types/financial.types';
 ...
 * @component
 * @param {IncomeStatementProps} props - Component props
 * @returns {JSX.Element | null} Income statement display
 */
export default function IncomeStatement({ data, period }: IncomeStatementProps): JSX.Element | null {
    if (!data) return null;
