...
/**
 * Generic entity with CRUD operations (Base44 signature)
 */
export interface EntityCRUD<T extends BaseEntity> {
  /** Entity name (optional, inferred from context) */
  name?: string;
  
  /** List all items with Base44 parameters */
  list: (sort?: string, limit?: number, skip?: number, fields?: string | string[]) => Promise<T[]>;
...
>>>>>>> acfeedfbaba92344cb4e3e39ab303d925eb02373
