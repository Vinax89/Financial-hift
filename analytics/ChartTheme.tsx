...
/**
 * Chart theme configuration with bar, line, and pie colors
 */
 ...
 * @returns {ChartThemeConfig} Chart theme configuration with colors
 */
export function getChartTheme(theme: string): ChartThemeConfig {
